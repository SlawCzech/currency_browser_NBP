    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "currency_values",
                    models.ManyToManyField(related_name="currency_values", to="currency.currencyvalue"),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "currency_names",
                    models.ManyToManyField(null=True, related_name="currency_dates", to="currency.currencyname"),
                ),
            ],
            options={
